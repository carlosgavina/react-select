	...
	render () {
		...
		return (
			<div ref="wrapper" className={selectClass}>
				...
				<div className="Select-control" ref="control" onKeyDown={this.handleKeyDown} onKeyUp={this.handleKeyUp} onMouseDown={this.handleMouseDown} onTouchEnd={this.handleMouseDown}>
					{value}
					{input}
					{loading}
					{clear}
